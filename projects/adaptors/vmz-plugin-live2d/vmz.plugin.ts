...
const hostSource = loadPluginSource(import.meta.url, 'components/Live2dHost.vmz');
    ...
    async contribute(ctx) {
        if (ctx.stage === 'workspace_resolve') {
            return {
                ...
                cacheKey: `@vmz/plugin-live2d:Live2dHost.vmz:${hostSource.contentHash.slice(0, 12)}`,
                items: [
                    {
                ...
                items: [
                    {
                        ...
                        path: 'src/components/Live2dHost.vmz',
                        severity: 'advice',
                        message: 'Live2dHost component online (@doki-land/live2d)',
                        code: 'vmz.plugin.live2d',
                    },
                ],
            };
        }
